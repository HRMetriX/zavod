...
Напиши пост в стиле Витька, учитывая, что ты не должен повторять описания из списка выше. Придумай новую обстановку, новые слова. В конце добавь строку:  

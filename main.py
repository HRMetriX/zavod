...
ВАЖНО: Текст самого поста (до 'PROMPT FOR IMAGE:') ДОЛЖЕН быть уложен в 800 символов, пробел считается отдельным символом. Не превышай этот лимит для основного текста. 
